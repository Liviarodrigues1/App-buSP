...
- O hardware deve ter conexão com a internet para mostrar ao [usuário](https://liviarodrigues1.github.io/App-buSP/modelagem/lexicos/#usuario) as estações e quantidade de bicicletas em cada uma.
...
- Os [usuário](https://liviarodrigues1.github.io/App-buSP/modelagem/lexicos/#usuario)s do software estarão sujeitos à lei de direitos autorais. Assim, o software será desenvolvido para um aplicativo de [aluguel de bicicletas](https://liviarodrigues1.github.io/App-buSP/modelagem/lexicos/#alugar), não sendo autorizada a cópia de trechos do programa para utilizações diversas.
