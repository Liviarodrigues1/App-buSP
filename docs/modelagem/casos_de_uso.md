...
### 1 - Caso de Uso: [Fazer cadastro](https://liviarodrigues1.github.io/App-buSP/modelagem/lexicos/#cadastrar-usuario)
...
| 3   | Descrição             | O usuário deverá conseguir fazer [cadastro](https://liviarodrigues1.github.io/App-buSP/modelagem/lexicos/#cadastrar-usuario) de sua conta                                     |
| 4   | Atores                | Usuário                                                                                    |
...
| 7   | Cenários Principais   | Usuário selecionar a opção fazer [criar conta](https://liviarodrigues1.github.io/App-buSP/modelagem/lexicos/#cadastrar-usuario)                                               |
...
### 2 - Caso de Uso: [Fazer login](https://liviarodrigues1.github.io/App-buSP/modelagem/lexicos/#logar) 
...
| 1   | Versão                | 1.0                                                                                                            |
| 2   | Autor                 | Victor Eduardo                                                                                                 |
| 3   | Descrição             | O usuário deverá conseguir [logar](https://liviarodrigues1.github.io/App-buSP/modelagem/lexicos/#logar) em sua conta                                                                  |
| 4   | Atores                | Usuário                                                                                                        |
| 5   | Pré-condições         | Dispositivo do usuário ter conexão com a internet, usuário estar com o aplicativo aberto                       |
| 6   | Pós-condições         | [Usuário](https://liviarodrigues1.github.io/App-buSP/modelagem/lexicos/#usuario) estar logado no sistema com sua conta                                                                  |
...
### 3 - Caso de Uso: [Assinar plano](https://liviarodrigues1.github.io/App-buSP/modelagem/lexicos/#plano)
...
| 6   | Pós-condições         | [Usuário](https://liviarodrigues1.github.io/App-buSP/modelagem/lexicos/#usuario) ter assinado um plano e poder retirar uma bicicleta                                                                                       |
...
| 8   | Cenários alternativos | Usuário abrir a aba lateral, selecionar a opção comprar plano, selecionar a cidade, a categoria do plano e o plano desejado, incluir cumpom de desconto, se houver, e [realizar pagamento](https://liviarodrigues1.github.io/App-buSP/modelagem/lexicos/#realizar-pagamento) |
...
| 1   | Versão                | 1.0                                                                                                            |
| 2   | Autor                 | Victor Eduardo                                                                                                 |
| 3   | Descrição             | O usuário deverá conseguir ver o mapa com as [estações](https://liviarodrigues1.github.io/App-buSP/modelagem/lexicos/#estacao) e bicicletas disponíveis em cada uma                     |
| 4   | Atores                | Usuário                                                                                                        |
| 5   | Pré-condições         | Dispositivo do usuário ter conexão com a internet, usuário estar com o aplicativo aberto                       |
...
### 5 - Caso de Uso: [Realizar viagem](https://liviarodrigues1.github.io/App-buSP/modelagem/lexicos/#começar) e devolução
...
| 3   | Descrição             | O usuário deverá conseguir assinar o [plano](https://liviarodrigues1.github.io/App-buSP/modelagem/lexicos/#plano) e retirar a bicicleta para realizar uma viagem e devolver no final do trajeto de acordo com a quantidade de vagas disponível em cada ponto                                                      |
| 4   | Atores                | Usuário                                                                                                                                        |
...
| 1   | Versão                | 1.0                                                                                                                                  |
| 2   | Autor                 | Lívia Rodrigues                                                                                                                      |
| 3   | Descrição             | O [usuário](https://liviarodrigues1.github.io/App-buSP/modelagem/lexicos/#usuario) deverá conseguir acessar a opção ajuda do menu para se informar e tirar dúvidas                                            |
| 4   | Atores                | Usuário                                                                                                                              |
| 5   | Pré-condições         | O usuário ter cadastro no aplicativo e fazer login                                                                                   |
| 6   | Pós-condições         | Usuário acessar a aba ajuda                                                                                                          |
| 7   | Cenários Principais   | Usuário conseguir acessar a aba ajuda para descobrir como o aplicativo funciona, cessar dúvidas sobre a conta, [planos](https://liviarodrigues1.github.io/App-buSP/modelagem/lexicos/#planos-disponiveis), [pagamentos](https://liviarodrigues1.github.io/App-buSP/modelagem/lexicos/#realizar-pagamento), desbloqueio/[devolução](https://liviarodrigues1.github.io/App-buSP/modelagem/lexicos/#devolver-bicicleta) e viagens                                                                                                                                                              |
...
### 7 - Caso de Uso: [Visualizar histórico de viagem](https://liviarodrigues1.github.io/App-buSP/modelagem/lexicos/#consultar-historico)
...
| 4   | Atores                | Usuário                                                                                                                           |
| 5   | Pré-condições         | O usuário fazer [login](https://liviarodrigues1.github.io/App-buSP/modelagem/lexicos/#logar) e já ter feito algum trajeto                                                                                |
...
| 8   | Cenários alternativos |  -                                                                                                                                |
| 9   | Cenários de exceção   | Usuário não ter feito nenhuma [viagem](https://liviarodrigues1.github.io/App-buSP/modelagem/lexicos/#começar) ainda                                                                                        |
